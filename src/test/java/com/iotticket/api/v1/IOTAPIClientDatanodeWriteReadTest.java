...
public class IOTAPIClientDatanodeWriteReadTest {
    ...
    private static final String TEST_BASE_URL = "http://localhost:" + WIREMOCK_PORT + "/";
    ...
    public void testWriteDatanodes_oneDatanode() throws Exception {
        ...
        stubFor(post(
                ...
                .withRequestBody(equalToJson(
                        ResourceFileUtils.resourceFileToString(
                                RESOURCE_FILE_LOCATION + "testWriteDatanodes_oneDatanodeRequestBody.json")))
                .withBasicAuth(TEST_USERNAME, TEST_PASSWORD)
                .willReturn(
                        aResponse()
                                .withStatus(200)
                                .withHeader("Content-Type", "application/json")
                                .withBody(ResourceFileUtils.resourceFileToString(
                                        RESOURCE_FILE_LOCATION + "testWriteDatanodes_oneDatanodeResponseBody.json")))
        );
        ...
        assertEquals(new URI("https://my.iot-ticket.com/api/v1/process/read/153ffceb982745e8b1e8abacf9c217f3/?datanodes=/Temperature"),
                result.getWriteResults().get(0).getHref());
    ...
    public void testWriteDatanodes_multipleDatanodes() throws Exception {
        ...
        stubFor(post(
                ...
                .withRequestBody(equalToJson(
                        ResourceFileUtils.resourceFileToString(
                                RESOURCE_FILE_LOCATION + "testWriteDatanodes_multipleDatanodesRequestBody.json")))
                .withBasicAuth(TEST_USERNAME, TEST_PASSWORD)
                .willReturn(
                        aResponse()
                                .withStatus(200)
                                .withHeader("Content-Type", "application/json")
                                .withBody(ResourceFileUtils.resourceFileToString(
                                        RESOURCE_FILE_LOCATION + "testWriteDatanodes_multipleDatanodesResponseBody.json")))
        );
    ...
    public void testReadDatanodes() throws Exception {
        ...
        stubFor(get(
                ...
                .willReturn(
                        aResponse()
                                ...
                                .withHeader("Content-Type", "application/json")
                                .withBody(ResourceFileUtils.resourceFileToString(
                                        RESOURCE_FILE_LOCATION + "testReadDatanodesResponseBody.json")))
        );
        ...
        assertEquals("https://my.iot-ticket.com/api/v1/process/read/153ffceb982745e8b1e8abacf9c217f3?todate=1546380000000&limit=3&datanodes=latitude%2Clongitude%2C%2FEngine%2FisRunning&fromdate=1546293600000",
    ...
    public void testReadDatanodes_noDataNodesFound() throws Exception {
        ...
        stubFor(get(
                ...
                .willReturn(
                        aResponse()
                                ...
                                .withHeader("Content-Type", "application/json")
                                .withBody(ResourceFileUtils.resourceFileToString(
                                        RESOURCE_FILE_LOCATION + "testReadDatanodes_noDatanodesFoundResponseBody.json")))
        );
        ...
        try {
            ...
            assertEquals("Request with server was unsuccesful, check the errorInfo object for further details",
                    exception.getMessage());

            ErrorInfo errorInfo = exception.getErrorInfo();
            assertEquals("The datanode(s) requested couldn't be found. Re-check request and try again",
        ...
        stubFor(get(
                ...
                .willReturn(
                        aResponse()
                                ...
                                .withHeader("Content-Type", "application/json")
                                .withBody(ResourceFileUtils.resourceFileToString(
                                        RESOURCE_FILE_LOCATION + "testGetDeviceDataNodesResponseBody.json")))
        );
        ...
        stubFor(get(
                ...
                .willReturn(
                        aResponse()
                                ...
                                .withHeader("Content-Type", "application/json")
                                .withBody(ResourceFileUtils.resourceFileToString(
                                        RESOURCE_FILE_LOCATION + "testGetDeviceDataNodes_noDatanodesFoundResponseBody.json")))
        );
