...
public class IOTAPIClientDeviceTest {
        ...
        stubFor(post(
                ...
                .withRequestBody(equalToJson(
                        ResourceFileUtils.resourceFileToString(
                                RESOURCE_FILE_LOCATION + "testRegisterDevice_withRequiredPropertiesOnlyRequestBody.json")))
                ...
                .willReturn(
                        aResponse()
                                ...
                                .withBody(ResourceFileUtils.resourceFileToString(
                                        RESOURCE_FILE_LOCATION + "testRegisterDevice_withRequiredPropertiesOnlyResponseBody.json")))
        );
    ...
    public void testRegisterDevice_withOptionalProperties() throws ValidAPIParamException, IOException, URISyntaxException {
        ...
        stubFor(post(
                ...
                .withRequestBody(equalToJson(
                        ResourceFileUtils.resourceFileToString(
                                RESOURCE_FILE_LOCATION + "testRegisterDevice_withOptionalPropertiesRequestBody.json")))
                .withBasicAuth(TEST_USERNAME, TEST_PASSWORD)
                .willReturn(
                        aResponse()
                                .withStatus(200)
                                .withHeader("Content-Type", "application/json")
                                .withBody(ResourceFileUtils.resourceFileToString(
                                        RESOURCE_FILE_LOCATION + "testRegisterDevice_withOptionalPropertiesResponseBody.json")))
        );
    ...
    public void testRegisterDevice_invalidCredentials() throws ValidAPIParamException, IOException, URISyntaxException {
        ...
        stubFor(post(
                ...
                .withRequestBody(equalToJson(
                        ResourceFileUtils.resourceFileToString(
                                RESOURCE_FILE_LOCATION + "testRegisterDeviceRequestBody.json")))
                .withBasicAuth(TEST_USERNAME, wrongPassword)
                .willReturn(
                        aResponse()
                                .withStatus(401)
                                .withBody(ResourceFileUtils.resourceFileToString(
                                        RESOURCE_FILE_LOCATION + "testRegisterDevice_invalidCredentialsResponseBody.json")))
        );
        ...
        stubFor(get(
                ...
                .willReturn(
                        aResponse()
                                ...
                                .withHeader("Content-Type", "application/json")
                                .withBody(ResourceFileUtils.resourceFileToString(
                                        RESOURCE_FILE_LOCATION + "testGetDevicesResponseBody.json")))
        );
        ...
        stubFor(get(
                ...
                .willReturn(
                        aResponse()
                                ...
                                .withHeader("Content-Type", "application/json")
                                .withBody(ResourceFileUtils.resourceFileToString(
                                        RESOURCE_FILE_LOCATION + "testGetDevices_noDevicesFoundResponseBody.json")))
        );
        ...
        stubFor(get(
                ...
                .willReturn(
                        aResponse()
                                ...
                                .withHeader("Content-Type", "application/json")
                                .withBody(ResourceFileUtils.resourceFileToString(
                                        RESOURCE_FILE_LOCATION + "testGetDeviceResponseBody.json")))
        );
        ...
        stubFor(get(
                ...
                .willReturn(
                        aResponse()
                                ...
                                .withHeader("Content-Type", "application/json")
                                .withBody(ResourceFileUtils.resourceFileToString(
                                        RESOURCE_FILE_LOCATION + "testGetDevice_deviceNotFoundResponseBody.json")))
        );
